"use strict";
(self["webpackChunkstarboard_notebook"] = self["webpackChunkstarboard_notebook"] || []).push([["node_modules_monaco-editor_esm_vs_basic-languages_javascript_javascript_js","node_modules_monaco-editor_esm_vs_basic-languages_typescript_typescript_js"],{
    ...
    onEnterRules: [
        {
            ...
            afterText: /^\s*\*\/$/,
            action: {
                indentAction: _fillers_monaco_editor_core_js__WEBPACK_IMPORTED_MODULE_0__/* .languages */ .eo.IndentAction.IndentOutdent,
                appendText: ' * '
            }
        },
        {
            ...
            beforeText: /^\s*\/\*\*(?!\/)([^\*]|\*(?!\/))*$/,
            action: {
                indentAction: _fillers_monaco_editor_core_js__WEBPACK_IMPORTED_MODULE_0__/* .languages */ .eo.IndentAction.None,
                appendText: ' * '
            }
        },
        {
...
//# sourceMappingURL=node_modules_monaco-editor_esm_vs_basic-languages_javascript_javascript_js.chunk.js.map