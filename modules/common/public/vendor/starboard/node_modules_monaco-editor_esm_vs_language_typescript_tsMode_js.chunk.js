"use strict";
(self["webpackChunkstarboard_notebook"] = self["webpackChunkstarboard_notebook"] || []).push([["node_modules_monaco-editor_esm_vs_language_typescript_tsMode_js"],{
...
var monaco_editor_core = __webpack_require__("../../node_modules/monaco-editor/esm/vs/language/typescript/fillers/monaco-editor-core.js");
        ...
        if (!this._client) {
            ...
            if (this._defaults.getEagerModelSync()) {
                p = p.then(function (worker) {
                    if (_this._worker) {
                        return _this._worker.withSyncedResources(monaco_editor_core/* editor */.EN
                            .getModels()
...
var LibFiles = /** @class */ (function () {
    ...
    LibFiles.prototype.getOrCreateModel = function (uri) {
        var model = monaco_editor_core/* editor */.EN.getModel(uri);
        if (model) {
            return model;
        }
        if (this.isLibFile(uri) && this._hasFetchedLibFiles) {
            return monaco_editor_core/* editor */.EN.createModel(this._libFiles[uri.path.slice(1)], 'typescript', uri);
        }
        return null;
    };
...
var DiagnosticsAdapter = /** @class */ (function (_super) {
    ...
    function DiagnosticsAdapter(_libFiles, _defaults, _selector, worker) {
        ...
        var onModelRemoved = function (model) {
            monaco_editor_core/* editor */.EN.setModelMarkers(model, _this._selector, []);
        ...
        _this._disposables.push(monaco_editor_core/* editor */.EN.onDidCreateModel(onModelAdd));
        _this._disposables.push(monaco_editor_core/* editor */.EN.onWillDisposeModel(onModelRemoved));
        _this._disposables.push(monaco_editor_core/* editor */.EN.onDidChangeModelLanguage(function (event) {
            onModelRemoved(event.model);
            onModelAdd(event.model);
        }));
        _this._disposables.push({
            dispose: function () {
                for (var _i = 0, _a = monaco_editor_core/* editor */.EN.getModels(); _i < _a.length; _i++) {
                    var model = _a[_i];
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        relatedUris = diagnostics
                            ...
                            return relatedInformation.file ? monaco_editor_core/* Uri */.zn.parse(relatedInformation.file.fileName) : null;
                        });
                    ...
                    case 3:
                        ...
                        monaco_editor_core/* editor */.EN.setModelMarkers(model, this._selector, diagnostics.map(function (d) { return _this._convertDiagnostics(model, d); }));
                        return [2 /*return*/];
                }
            });
        });
    ...
    DiagnosticsAdapter.prototype._convertDiagnostics = function (model, diag) {
        ...
        if (diag.reportsUnnecessary) {
            tags.push(monaco_editor_core/* MarkerTag */.d_.Unnecessary);
        }
        if (diag.reportsDeprecated) {
            tags.push(monaco_editor_core/* MarkerTag */.d_.Deprecated);
        }
        return {
    ...
    DiagnosticsAdapter.prototype._convertRelatedInformation = function (model, relatedInformation) {
        ...
        relatedInformation.forEach(function (info) {
            ...
            if (info.file) {
                var relatedResourceUri = monaco_editor_core/* Uri */.zn.parse(info.file.fileName);
...
var SuggestAdapter = /** @class */ (function (_super) {
            ...
            return languageFeatures_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        wordRange = new monaco_editor_core/* Range */.Q6(position.lineNumber, wordInfo.startColumn, position.lineNumber, wordInfo.endColumn);
                        resource = model.uri;
                    ...
                    case 2:
                        ...
                        suggestions = info.entries.map(function (entry) {
                            ...
                            if (entry.replacementSpan) {
                                ...
                                range = new monaco_editor_core/* Range */.Q6(p1.lineNumber, p1.column, p2.lineNumber, p2.column);
                            }
                            var tags = [];
                            if (((_a = entry.kindModifiers) === null || _a === void 0 ? void 0 : _a.indexOf('deprecated')) !== -1) {
                                tags.push(monaco_editor_core/* languages */.eo.CompletionItemTag.Deprecated);
                            }
                            return {
                                uri: resource,
                                position: position,
    ...
    SuggestAdapter.convertKind = function (kind) {
        switch (kind) {
            ...
            case Kind.keyword:
                return monaco_editor_core/* languages */.eo.CompletionItemKind.Keyword;
            case Kind.variable:
            case Kind.localVariable:
                return monaco_editor_core/* languages */.eo.CompletionItemKind.Variable;
            case Kind.memberVariable:
            case Kind.memberGetAccessor:
            case Kind.memberSetAccessor:
                return monaco_editor_core/* languages */.eo.CompletionItemKind.Field;
            case Kind.function:
            case Kind.memberFunction:
            case Kind.constructSignature:
            case Kind.callSignature:
            case Kind.indexSignature:
                return monaco_editor_core/* languages */.eo.CompletionItemKind.Function;
            case Kind.enum:
                return monaco_editor_core/* languages */.eo.CompletionItemKind.Enum;
            case Kind.module:
                return monaco_editor_core/* languages */.eo.CompletionItemKind.Module;
            case Kind.class:
                return monaco_editor_core/* languages */.eo.CompletionItemKind.Class;
            case Kind.interface:
                return monaco_editor_core/* languages */.eo.CompletionItemKind.Interface;
            case Kind.warning:
                return monaco_editor_core/* languages */.eo.CompletionItemKind.File;
        }
        return monaco_editor_core/* languages */.eo.CompletionItemKind.Property;
    };
...
var SignatureHelpAdapter = /** @class */ (function (_super) {
    ...
    SignatureHelpAdapter._toSignatureHelpTriggerReason = function (context) {
        switch (context.triggerKind) {
            case monaco_editor_core/* languages */.eo.SignatureHelpTriggerKind.TriggerCharacter:
            ...
            case monaco_editor_core/* languages */.eo.SignatureHelpTriggerKind.ContentChange:
                return context.isRetrigger ? { kind: 'retrigger' } : { kind: 'invoked' };
            case monaco_editor_core/* languages */.eo.SignatureHelpTriggerKind.Invoke:
            default:
                return { kind: 'invoked' };
        }
    };
                        ...
                        return [2 /*return*/, entries.map(function (entry) {
                                return {
                                    ...
                                    kind: entry.isWriteAccess
                                        ? monaco_editor_core/* languages */.eo.DocumentHighlightKind.Write
                                        : monaco_editor_core/* languages */.eo.DocumentHighlightKind.Text
                                };
                            })];
                }
            });
            ...
            return languageFeatures_generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._libFiles.fetchLibFilesIfNecessary(entries.map(function (entry) { return monaco_editor_core/* Uri */.zn.parse(entry.fileName); }))];
                    case 3:
                        // Fetch lib files if necessary
                        _a.sent();
                        if (model.isDisposed()) {
                        ...
                        for (_i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
                            entry = entries_1[_i];
                            uri = monaco_editor_core/* Uri */.zn.parse(entry.fileName);
                    ...
                    case 2:
                        ...
                        convert = function (bucket, item, containerLabel) {
                            var result = {
                                name: item.text,
                                detail: '',
                                kind: (outlineTypeTable[item.kind] || monaco_editor_core/* languages */.eo.SymbolKind.Variable),
...
outlineTypeTable[Kind.module] = monaco_editor_core/* languages */.eo.SymbolKind.Module;
outlineTypeTable[Kind.class] = monaco_editor_core/* languages */.eo.SymbolKind.Class;
outlineTypeTable[Kind.enum] = monaco_editor_core/* languages */.eo.SymbolKind.Enum;
outlineTypeTable[Kind.interface] = monaco_editor_core/* languages */.eo.SymbolKind.Interface;
outlineTypeTable[Kind.memberFunction] = monaco_editor_core/* languages */.eo.SymbolKind.Method;
outlineTypeTable[Kind.memberVariable] = monaco_editor_core/* languages */.eo.SymbolKind.Property;
outlineTypeTable[Kind.memberGetAccessor] = monaco_editor_core/* languages */.eo.SymbolKind.Property;
outlineTypeTable[Kind.memberSetAccessor] = monaco_editor_core/* languages */.eo.SymbolKind.Property;
outlineTypeTable[Kind.variable] = monaco_editor_core/* languages */.eo.SymbolKind.Variable;
outlineTypeTable[Kind.const] = monaco_editor_core/* languages */.eo.SymbolKind.Variable;
outlineTypeTable[Kind.localVariable] = monaco_editor_core/* languages */.eo.SymbolKind.Variable;
outlineTypeTable[Kind.variable] = monaco_editor_core/* languages */.eo.SymbolKind.Variable;
outlineTypeTable[Kind.function] = monaco_editor_core/* languages */.eo.SymbolKind.Function;
outlineTypeTable[Kind.localFunction] = monaco_editor_core/* languages */.eo.SymbolKind.Function;
// --- formatting ----
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        for (_i = 0, renameLocations_1 = renameLocations; _i < renameLocations_1.length; _i++) {
                            ...
                            resource_1 = monaco_editor_core/* Uri */.zn.parse(renameLocation.fileName);
                            model_1 = monaco_editor_core/* editor */.EN.getModel(resource_1);
                            if (model_1) {
                                edits.push({
                                    resource: resource_1,
                                    edit: {
...
function setupMode(defaults, modeId) {
    ...
    monaco_editor_core/* languages */.eo.registerCompletionItemProvider(modeId, new SuggestAdapter(worker));
    monaco_editor_core/* languages */.eo.registerSignatureHelpProvider(modeId, new SignatureHelpAdapter(worker));
    monaco_editor_core/* languages */.eo.registerHoverProvider(modeId, new QuickInfoAdapter(worker));
    monaco_editor_core/* languages */.eo.registerDocumentHighlightProvider(modeId, new OccurrencesAdapter(worker));
    monaco_editor_core/* languages */.eo.registerDefinitionProvider(modeId, new DefinitionAdapter(libFiles, worker));
    monaco_editor_core/* languages */.eo.registerReferenceProvider(modeId, new ReferenceAdapter(libFiles, worker));
    monaco_editor_core/* languages */.eo.registerDocumentSymbolProvider(modeId, new OutlineAdapter(worker));
    monaco_editor_core/* languages */.eo.registerDocumentRangeFormattingEditProvider(modeId, new FormatAdapter(worker));
    monaco_editor_core/* languages */.eo.registerOnTypeFormattingEditProvider(modeId, new FormatOnTypeAdapter(worker));
    monaco_editor_core/* languages */.eo.registerCodeActionProvider(modeId, new CodeActionAdaptor(worker));
    monaco_editor_core/* languages */.eo.registerRenameProvider(modeId, new RenameAdapter(worker));
